...
<dialog id="editor">
    ...
    >
    <ToolButton bind:current_tool button_tool={Tool.DrawCircle}
        >Circle</ToolButton
    >
    ...
    <ToolButton bind:current_tool button_tool={Tool.DrawFilledRectangle}>Filled Rectangle</ToolButton>
    <ToolButton bind:current_tool button_tool={Tool.DrawFilledCircle}>Filled Circle</ToolButton>
    <ToolButton bind:current_tool button_tool={Tool.DrawFilledPolygon}>Filled Polygon</ToolButton>
    <Canvas
        bind:current_tool
        bind:current_color
